...
export {
  DIVISIONS, CLUBS_PER_DIVISION, SWAP, CLUBS_D2, DIVISION_NAME, DIVISION_PRIZE_FACTOR, DIVISION_REVENUE_FACTOR, PARACHUTE_FACTOR, revenueFactor,
...
export {
  TALK_MAX, TALK_SCALE, TALK_HEADROOM, STALE_STEP, STALE_WEIGHTS, TALK_LOG_MAX, TONES, staleness, heardFit, roomAverage, talkLog, toneFit, halfTimeFit, fullTimeFit, talkAttrDelta, HALF_TIME_MATCH_SCALE, reactionOf, talkOptions, talkGiven, giveTalk,
