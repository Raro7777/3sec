...
/**
 * The second division's twelve clubs.
 *
 * Reputation runs 8.8-11.6 against the top flight's 10.5-14, and the number was measured rather than
 * guessed. The two ranges have to genuinely overlap, not merely touch: at 8.2-11.0 the squads they
 * produced averaged 11.2 against 13.8 on the first eleven, and 58% of promoted clubs went straight
 * back down. Lifting the division by a full 1.2 overshot to 17%, with promoted clubs settling in
 * mid-table, so this sits at half of that. Real football relegates roughly a third of the clubs it
 * promotes, which is the figure to hold this against.
 */
export const CLUBS_D2: { name: string; shortName: string; color: string; reputation: number; formation: FormationName; capacity: number }[] = [
  { name: "청주 스톤즈", shortName: "청주", color: "#8d99ae", reputation: 11.6, formation: "4-4-2", capacity: 15000 },
  { name: "안양 퍼플", shortName: "안양", color: "#7b2cbf", reputation: 11.3, formation: "4-2-3-1", capacity: 17000 },
  { name: "김포 타이드", shortName: "김포", color: "#118ab2", reputation: 11.0, formation: "4-3-3", capacity: 12000 },
  { name: "천안 브릭스", shortName: "천안", color: "#bc6c25", reputation: 10.8, formation: "4-4-2", capacity: 14000 },
  { name: "여수 게일즈", shortName: "여수", color: "#00b4d8", reputation: 10.5, formation: "3-5-2", capacity: 11000 },
  { name: "원주 하이랜더스", shortName: "원주", color: "#606c38", reputation: 10.3, formation: "4-4-2", capacity: 13000 },
  { name: "군산 하버", shortName: "군산", color: "#264653", reputation: 10.0, formation: "4-2-3-1", capacity: 10000 },
  { name: "충주 밀즈", shortName: "충주", color: "#e07a5f", reputation: 9.8, formation: "4-3-3", capacity: 9000 },
  { name: "속초 웨일스", shortName: "속초", color: "#457b9d", reputation: 9.6, formation: "4-4-2", capacity: 8000 },
  { name: "구미 서킷", shortName: "구미", color: "#ffb703", reputation: 9.4, formation: "4-3-3", capacity: 12000 },
  { name: "목포 앵커스", shortName: "목포", color: "#5f0f40", reputation: 9.1, formation: "3-5-2", capacity: 9000 },
  { name: "정선 마운티스", shortName: "정선", color: "#3d5a80", reputation: 8.8, formation: "4-4-2", capacity: 7000 },
];
