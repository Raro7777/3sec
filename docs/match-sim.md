...
> 상태: 프로토타입 구현 완료(`sim/`), 몬테카를로 캘리브레이션 4차(v0.1) + **포지션 가치 재캘리브레이션 5회(v0.2)** 반영. 이 문서의 상수는 `SimConfig` 기본값과 일치한다. v0.2 에서 바뀐 판정식은 6.4·6.6~6.9 절에 표시했고, 결과는 밸런스 리포트의 v0.2 절에 있다.
