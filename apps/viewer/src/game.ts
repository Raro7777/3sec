...
export class Game {
  ...
  private renderGuide(): void {
    ...
    ${sec("상대 감독", `<ul>
      ...
      <li><b>외국인 규정</b>: 보유 ${FOREIGN_QUOTA}명, 동시 선발 ${FOREIGN_ON_PITCH}명까지입니다. 해외 구단 선수는 이적 탭의 <b>해외</b> 필터에서 찾을 수 있고 호가가 ${Math.round((FOREIGN_PREMIUM - 1) * 100)}% 비쌉니다. AI 구단도 창구마다 한 명씩 외국인을 데려오고, 1부 스타에게는 해외 구단의 제안이 들어오기도 합니다.</li>
