...
function create(canvas, opts) {
  ...
  var HAIR_PAL = [null, ['#2B2D3A', '#1A1B26'], ['#4A3328', '#33221A'], ['#7A4F35', '#563524'], ['#A9764F', '#7E5539'],
                  ...
                  ['#E07A3C', '#B05520'],    // 13 = 선셋 오렌지
                  ['#8A7C6E', '#5E5349'],    // 14 = 애쉬 브라운(따뜻한 토프) — 애쉬 그레이(6)와 구분
                  ['#565A63', '#383B42'],    // 15 = 차콜 그레이(짙은 회색) — 애쉬 그레이(6)와 구분
                  ['#C9923F', '#94661E']];   // 16 = 골든 브라운(황금빛) — 라이트 브라운(4)과 구분
