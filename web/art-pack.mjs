 ...
 */
// 팔레트 16색(art-style-guide 2.7). 13~16 은 가이드 12색을 넘어 추가한 것 — 같은 구단 안에서 회색·브라운이
// 겹치던 3쌍(art-pipeline 열린 이슈)과 팔레트 밖이던 선셋 오렌지를 분리하려고 확장했다.
const HAIR_PALETTE = {
  '블랙': 1, '다크 브라운': 2, '체스트넛 브라운': 3, '라이트 브라운': 4, '애쉬 브라운': 14, '애쉬 그레이': 6, '차콜 그레이': 15,
  '로즈 브라운': 3, '밀크티 베이지': 5, '골든 브라운': 16, '허니 블론드': 5, '오번': 8, '플래티넘 블론드': 7, '와인 레드': 8,
