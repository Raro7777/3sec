...
const HAIR_COLOR = {
  ...
  '애쉬 브라운':     { tag: 'light brown hair, ashen hair',        palette: 14 },
  '애쉬 그레이':     { tag: 'grey hair, ash grey hair',            palette: 6 },
  '차콜 그레이':     { tag: 'grey hair, dark grey hair',           palette: 15 },
  '로즈 브라운':     { tag: 'brown hair, pinkish brown hair',      palette: 3 },
  '밀크티 베이지':   { tag: 'light brown hair, beige hair',        palette: 5 },
  '골든 브라운':     { tag: 'light brown hair, golden brown hair', palette: 16 },
  ...
  '선셋 오렌지':     { tag: 'orange hair',                         palette: 13 },
